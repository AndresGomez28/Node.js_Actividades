...
db.once('open', () => {
    ...
    const Empresa = mongoose.model('Empresas', userShema);
    ...
    app.get('/api/users/country/:region', async (req, res) => {
        const users = await User.find({ciudad: req.params.region});
        res.json(users)
    });
    ...
    app.get('/api/empresas/:id', async (req, res) => {
        ...
        const empresas = await Empresa.find({id: id});
        res.json(empresas)
    });

    app.get('/api/empresas/city/:ciudad', async (req, res) => {
        const empresas = await Empresa.find({ciudad: req.params.ciudad});
        res.json(empresas)
    });
